...
namespace UnityEditor.Rendering.Universal
{
    ...
    internal class ShaderScriptableStripper : IShaderVariantStripper, IShaderVariantStripperScope
    {
        ...
        LocalKeyword m_ToneMapPBRNeutral;
        ...
        private void InitializeLocalShaderKeywords([DisallowNull] Shader shader)
        {
            ...
            m_ToneMapPBRNeutral = TryGetLocalKeyword(shader, ShaderKeywordStrings.TonemapPBRNeutral);
        ...
        *********************************************************/
        ...
        internal bool StripVolumeFeatures_UberPostShader(ref IShaderScriptableStrippingData strippingData)
        {
            ...
            if (stripTool.StripMultiCompileKeepOffVariant(m_ToneMapGT, VolumeFeatures.ToneMapping))
                return true;
            ...
            if (stripTool.StripMultiCompileKeepOffVariant(m_ToneMapPBRNeutral, VolumeFeatures.ToneMapping))
                return true;
