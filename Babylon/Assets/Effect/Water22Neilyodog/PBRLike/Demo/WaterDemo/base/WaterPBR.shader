Shader "Neilyodog/WaterPBR"
{
    ...
    Properties
    {
        ...
        [Toggle(_CUSTOM_LIGHT_DIR)]_UseCustomLightDir("自定义灯光方向",int) = 0
        [HideInInspector]_TLEnvLightDir("灯光方向",Vector) = (0, 0.7071, -0.7071, 0)
        _CustomLightColor("自定义灯光颜色",Color) = (1, 1, 1, 1)
        _CustomLightIntensity("自定义灯光强度",Range(0, 8)) = 1
        ...
        [Enum(WaterSide,0,Depth,1,SH,2,Fresnel,3,Shadow,4,VertexAnim,5,Specular,6,NormalFlat,7,VertexColor,8,Sparkle,9)]_Debug("Debug", Float) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local _CUSTOM_LIGHT_DIR
