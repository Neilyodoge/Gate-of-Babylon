...
Shader "Universal Render Pipeline/Lit_BentNormal"
{
    Properties
    {
        ...
        // SRP batching compatibility for Clear Coat
    ...
    SubShader
    {
        ...
        // ------------------------------------------------------------------
        //  Forward pass - 使用 Bent Normal 版本的光照
        Pass
        {
            Name "ForwardLit"
            Tags
            ...
            // Shader Stages
            #pragma vertex LitBentNormalPassVertex
            #pragma fragment LitBentNormalPassFragment
            ...
            // Visibility Cone 关键字 (Bent Normal 存储在 UV 中)
            #pragma shader_feature_local _VISIBILITY_ON
            ...
            // 使用自定义的 Input 和 Forward Pass
            #include "Lit_BentNormalInput.hlsl"
            #include "Lit_BentNormalForwardPass.hlsl"
            ENDHLSL
        }
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.LitBentNormalShaderGUI"
}
