...
namespace DunGen
{
	...
	[Serializable]
    [Obsolete("Obsolete in 2.19. Please use DunGen.Weighting.WeightedEntry<T> and WeightedTable<T> instead")]
    ...
    /// This is a legacy class - new code should use <see cref="DunGen.Weighting.WeightedTable{T}"/> instead
    /// </summary>
    [Serializable]
	[Obsolete("Obsolete in 2.19. Please use DunGen.Weighting.WeightedTable<T> instead")]
