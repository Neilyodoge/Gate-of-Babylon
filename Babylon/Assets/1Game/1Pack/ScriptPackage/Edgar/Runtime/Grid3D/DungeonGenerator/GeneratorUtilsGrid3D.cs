...
namespace Edgar.Unity
{
    ...
    {
        public static DungeonGeneratorLevelGrid3D TransformLayout(LayoutGrid2D<RoomBase> layout, LevelDescriptionGrid3D levelDescription, GameObject rootGameObject, Random random, GeneratorSettingsGrid3D generatorSettings, int seed)
        {
            ...
            return new DungeonGeneratorLevelGrid3D(roomToRoomInstanceMapping, rootGameObject, levelDescription, random, generatorSettings, seed);
        }
