...
namespace Map
{
    public class MapViewUI : MapView
    {
        ...
        /// <summary>本项目桥接：运行时（代码搭建 Canvas 时）回填两个 ScrollRect 引用。</summary>
        public void SetScrollRects(ScrollRect horizontal, ScrollRect vertical)
        {
            scrollRectHorizontal = horizontal;
            scrollRectVertical = vertical;
        }
