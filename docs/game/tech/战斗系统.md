...
> **状态：旧《秘境探索》程序深档。** ProjectR现行战斗设计见[载体与回路](../design/systems/载体与回路.md)，迁移边界见[技术架构](../architecture/README.md)。  
...
- 配套文档：
  ...
  - [灵物系统](灵物系统.md)
  - [GDD](../design/GDD_秘境探索.md) · [CHANGELOG](../CHANGELOG.md) · [开发待办](../design/开发待办.md)
